...
proc finish {} {
    ...
    close $file1
    exec nam out.nam &
	exec awk -f /home/iii106120018/NW106120018/Lab9/plr.awk all.tr > plr_out &
	exec awk -f /home/iii106120018/NW106120018/Lab9/overhead.awk all.tr > overhead_out &
	exec awk -f /home/iii106120018/NW106120018/Lab9/throughput.awk all.tr > throughput_out &
    exit 0
}
...
if {$opt(cd) == "1"} {
    set lan0 [$ns newLan $nodelist $opt(nc) 30ms LL Queue/DropTail MAC/Csma/Cd Channel]
} else {

    #set lan0 [$ns make-lan $nodelist $opt(nc) 30ms LL Queue/DropTail Mac/Sat/SlottedAloha Channel]
    set lan0 [$ns newLan $nodelist $opt(nc) 30ms LL Queue/DropTail Mac/SlottedAloha Channel]
}

...
proc finish {} {
	...
	close $nf
	exec nam out.nam &
	exec awk -f /home/iii106120018/NW106120018/Lab8/pdr.awk all.tr > pdr_out_lsr &
	exec awk -f /home/iii106120018/NW106120018/Lab8/plr.awk all.tr > plr_out_lsr &
	exec awk -f /home/iii106120018/NW106120018/Lab8/overhead.awk all.tr > overhead_out_lsr &
	exec awk -f /home/iii106120018/NW106120018/Lab8/energyC.awk all.tr > energyC_out_lsr &
	exit 0
}

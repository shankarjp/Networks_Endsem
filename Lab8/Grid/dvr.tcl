...
proc finish {} {
	...
	close $nf
	exec nam out.nam & 
	exec awk -f /home/iii106120018/NW106120018/Lab8/pdr.awk all.tr > /outfiles/pdr_out_dvr &
	exec awk -f /home/iii106120018/NW106120018/Lab8/pdr.awk all.tr > /outfiles/plr_out_dvr &
	exec awk -f /home/iii106120018/NW106120018/Lab8/pdr.awk all.tr > /outfiles/overhead_out_dvr &
	exec awk -f /home/iii106120018/NW106120018/Lab8/pdr.awk all.tr > /outfiles/energyC_out_dvr &
	exit 0
}

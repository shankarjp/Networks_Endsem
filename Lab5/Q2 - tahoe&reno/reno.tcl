...
proc finish {} {
        ...
        exec nam out.nam &
	exec awk -f ../scripts/pdr.awk all.tr > ${traffic}_reno_pdr_out &
	exec awk -f ../scripts/overhead.awk all.tr > ${traffic}_reno_overhead_out &
	exec awk -f ../scripts/congestion.awk all.tr > ${traffic}_reno_congestion_out &
	exit 0
}

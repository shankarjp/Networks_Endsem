...
proc finish {} {
        ...
        exec nam out.nam &
	exec awk -f /home/mysql106120116/Desktop/106120116/Lab5/rb/Que2/pdr.awk all.tr > ${traffic}_thao_pdr_out &
	exec awk -f /home/mysql106120116/Desktop/106120116/Lab5/rb/Que2/overhead.awk all.tr > ${traffic}_thao_overhead_out &
	exec awk -f /home/mysql106120116/Desktop/106120116/Lab5/rb/Que2/congestion.awk all.tr > ${traffic}_thao_congestion_out &
	exit 0
}

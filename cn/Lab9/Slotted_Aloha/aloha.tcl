...
proc finish {} {
    ...
    close $file1
    exec nam out.nam &
    exec awk -f //home/mysql106120124/Desktop/CN/Lab9/Slotted_Aloha/throughput.awk out1.tr > throughput_out &
    exec awk -f //home/mysql106120124/Desktop/CN/Lab9/Slotted_Aloha/overhead.awk out1.tr > overhead_out &
    exec awk -f //home/mysql106120124/Desktop/CN/Lab9/Slotted_Aloha/plr.awk out1.tr > plr_out &
    exit 0
}
...
if {$opt(cd) == "1"} {
    ...
    set lan0 [$ns newLan $nodelist $opt(nc) 30ms LL Queue/DropTail Mac/Sat/SlottedAloha Channel]
}

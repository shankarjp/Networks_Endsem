...
proc finish {} {
    ...
    close $file1
    exec nam out.nam &
    exec awk -f //home/mysql106120124/Desktop/CN/Lab9/csma_ca/throughput.awk out1.tr > throughput_out &
    exec awk -f //home/mysql106120124/Desktop/CN/Lab9/csma_ca/overhead.awk out1.tr > overhead_out &
    exec awk -f //home/mysql106120124/Desktop/CN/Lab9/csma_ca/plr.awk out1.tr > plr_out &
    # exec awk -f //home/mysql106120124/Desktop/CN/Lab9/csma_ca/fair.awk out1.tr > fair_out &
